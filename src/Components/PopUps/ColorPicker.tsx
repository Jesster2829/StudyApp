...
export function ColorPicker({
  ...
  const colors = [
    ...
    '#795548', '#EFEBE9', '#D7CCC8', '#BCAAA4', '#A1887F', '#8D6E63', '#795548', '#6D4C41', '#5D403F7', '#4E342E',
  ...
  return (
    <div>
      <Button onClick={handleButtonClick} sx={{ color: "primary.main", backgroundColor: "secondary.main" }}>
        Show Color Picker
        </Button>
      <Dialog open={showPicker} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          >
            {colors.map((color, i) => (
              <Box
                key={i}
                sx={{ backgroundColor: color, height: 20, width: 20 }}
